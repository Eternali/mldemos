...
typedef ExpansionChanger = Future Function(bool expand);
...
class ControlledExpansion extends StatefulWidget {
  ...
  final ExpansionChanger changeExpansion;

  @override
  State<ControlledExpansion> createState() =>  _ControlledExpansionState();
}

class _ControlledExpansionState extends State<ControlledExpansion> with SingleTickerProviderStateMixin {
  ...
  void _handleTap() {
    setState(() {
      widget.changeExpansion(!widget.isExpanded).then(onValue)
      if (widget.isExpanded)
        _controller.forward();
      else
